...
public class Solution {
    ...
    private class SuperUser {
        ...
        //доступ к этому методу возможен только внутри класса amy.Solution, т.к. модификатор иннер класса private
    ...
    public static void main(String[] args) {
        ...
        //внутри класса amy.Solution (а сейчас мы внутри) к методу getDescription можно обращаться обоими способами
