...
public class Solution {
    ...
    private class TaskDataProvider implements DbDataProvider<DbMock>{
    ...
    private class NameDataProvider implements DbDataProvider<DbMock>{
