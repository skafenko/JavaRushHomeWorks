...
2. В классе amy.Solution для каждого класса создайте свой метод, который возвращает список экземпляров класса.
...
public class Solution {
    ...
    public List<Server> getServers(){return new AbstractDbSelectExecutor<Server>() {
    ...
    public List<Subscription> getSubscriptions(){return new AbstractDbSelectExecutor<Subscription>() {
    ...
    public List<Subject> getSubjects(){return new AbstractDbSelectExecutor<Subject>() {
    ...
    public List<User> getUsers(){return new AbstractDbSelectExecutor<User>() {
