...
/* Общий список
1. Изменить класс amy.Solution так, чтобы он стал списком. (Необходимо реализовать интерфейс java.util.List).
2. Список amy.Solution должен работать только с целыми числами Long.
